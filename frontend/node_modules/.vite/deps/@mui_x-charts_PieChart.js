...
import "./chunk-UXCGPDSV.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-YR5LAKKR.js";
import "./chunk-3P5QPSQE.js";
import "./chunk-X665VRZW.js";
import "./chunk-6AO67CZR.js";
import {
  useTheme
...
function LegendPerItem(props) {
  ...
  const theme = useTheme();
  const drawingArea = useDrawingArea();
  const labelStyle = React60.useMemo(
  ...
  const padding = React60.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React60.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React60.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React60.useMemo(() => {
...
function useAxis({
  ...
  const {
    zAxis,
    zAxisIds
  } = React63.useContext(ZAxisContext);
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime27.jsxs)(React64.Fragment, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime29.jsxs)(React66.Fragment, {
...
var PieChart = React77.forwardRef(function PieChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPieChart"
  });
